...
describe('gms function test', function () {
    it('returns module classNames by it\'s keys', function () {
        ...
        var gsm = (0, index_1.createGms)(styles);
    ...
    it('throws exception when no styles provided', function () {
        expect(function () { return (0, index_1.createGms)(undefined); }).toThrow();
    });
...
//# sourceMappingURL=gms.test.js.map
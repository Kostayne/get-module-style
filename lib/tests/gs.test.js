...
describe('gs function test', function () {
    ...
    it('works with object like { className: undefined }', function () {
        var classNames = (0, index_1.gs)('text', { red: undefined }, { big: true });
        expect(classNames).toBe('text big');
    });
    it('works with object like { className: null }', function () {
        var classNames = (0, index_1.gs)('text', { red: null }, { big: true });
        expect(classNames).toBe('text big');
    });
});
